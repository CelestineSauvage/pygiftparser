        ...
        for i,form in enumerate(soup.find_all('form')):
            ...
            for j,div in enumerate(form.find_all('div')):
                if j == 0 :
                    ...
                    self.assertEqual(str(div.contents[0]), "<p>Pourquoi faut-il <strong>repr\xc3\xa9senter</strong> les textes, images, sons, etc, <em>par</em> des nombres dans un ordinateur ?</p>")
                if (j == 1):
                    if (i == 0):
